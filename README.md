...
Celem eksperymentu jest sprawdzenie, czy da się łatwo stworzyć subsystem w blueprincie.

# Próba zero

1. Stwórz nowy projekt.
2. Zadeklaruj klasę TestSubsystem, dziedziczący po GameInstanceSubsystem, która jest Abstract
3. W edytorze stwórz blueprint BP_TestSubsystem dziedziczący po TestSubsystem
